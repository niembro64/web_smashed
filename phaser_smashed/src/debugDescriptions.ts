...
export const debugDescriptions: DebugDescriptions = {
  ...
  Mode_Infinity: [
    'Game Mode',
    'TRUE: play until shots are exhausted',
    'FALSE: play until time is exhausted',
  ],
  ...
  Allow_Shell_Chars: ['Allow shell characters to be used in the game'],
  ...
  Flower_HighTrajectory: [
    'Fire flower shoots at a high trajectory (ballistics)',
  ],
};
